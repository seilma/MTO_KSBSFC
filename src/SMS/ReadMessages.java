...
public class ReadMessages
{
        public void doIt() throws Exception
        {
                ...
                try
                {
                        ...
                        SerialModemGateway gateway = new SerialModemGateway("modem.com14", "COM14", 460800, "", "");
                        ...
                        Service.getInstance().getKeyManager().registerKey("+21651021649", new AESKey(new SecretKeySpec("0011223344556677".getBytes(), "AES")));
